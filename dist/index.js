...
const getFileTree = (dir, settings) =>
...
const fileData = (settings) =>
	__awaiter(void 0, void 0, void 0, function* () {
		yield utils_1.asyncForEach(settings.files, (file) =>
			__awaiter(void 0, void 0, void 0, function* () {
...
const getPackageInformation = (settings) =>
	__awaiter(void 0, void 0, void 0, function* () {
		try {
			let PackageData = yield readFile("package.json").then((res) =>
				res.toString()
			);
...
const loadLocalConfig = (settings) =>
	__awaiter(void 0, void 0, void 0, function* () {
		try {
			let configData = yield readFile("dokkie.config.json").then((res) =>
...
const getLayout = (settings) =>
	__awaiter(void 0, void 0, void 0, function* () {
		let layoutFile = "";
		if (settings.layout.includes(".hbs") || settings.layout.includes(".html")) {
			layoutFile = yield readFile(
				path_1.join(process.cwd(), settings.layout)
			).then((res) => res.toString());
		} else {
			layoutFile = yield readFile(
				path_1.join(__dirname, "../", `template/${settings.layout}.hbs`)
			).then((res) => res.toString());
		}
		return Object.assign(Object.assign({}, settings), { layout: layoutFile });
	});
const setMeta = (settings) =>
	__awaiter(void 0, void 0, void 0, function* () {
		const files = yield Promise.all(
			settings.files.map((file) =>
				__awaiter(void 0, void 0, void 0, function* () {
					return (file = Object.assign(Object.assign({}, file), {
						title: yield utils_1.getTitle(file),
						route: utils_1.makeRoute(file, settings),
						destpath: utils_1.makePath(file, settings),
						filename: utils_1.makeFileName(file),
					}));
				})
			)
		).then((res) => res);
...
const getStyles = (settings) => {
	...
	if (
		(_b =
			(_a = settings.localConfig) === null || _a === void 0
				? void 0
				: _a.add) === null || _b === void 0
			? void 0
			: _b.stylesheets
	)
	...
	if (
		(_d =
			(_c = settings.localConfig) === null || _c === void 0
				? void 0
				: _c.overrule) === null || _d === void 0
			? void 0
			: _d.stylesheets
	)
		styles =
			(_f =
				(_e = settings.localConfig) === null || _e === void 0
					? void 0
					: _e.overrule) === null || _f === void 0
				? void 0
				: _f.stylesheets;
...
const createFolder = (settings) =>
	__awaiter(void 0, void 0, void 0, function* () {
		if (settings.cleanBefore) rimraf_1.default.sync(settings.output);
	});
const createFiles = (settings) =>
	__awaiter(void 0, void 0, void 0, function* () {
			...
			__awaiter(void 0, void 0, void 0, function* () {
				try {
					...
					yield utils_1.writeThatFile(
						file,
						prettier_1.default.format(contents, { parser: "html" })
					);
				} catch (err) {
					console.log(err);
				}
...
const copyFolders = (settings) =>
	__awaiter(void 0, void 0, void 0, function* () {
		if (settings.copy.length > 0) {
			log.BLOCK_MID("Copy folders");
			yield utils_1.asyncForEach(settings.copy, (folder) =>
				__awaiter(void 0, void 0, void 0, function* () {
...
const buildNavigation = (settings) =>
	__awaiter(void 0, void 0, void 0, function* () {
		let nav = [];
		...
		return Object.assign(Object.assign({}, settings), {
			navigation: settings.flatNavigation ? nav : newNav,
		});
	});
